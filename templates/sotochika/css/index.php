		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5 col-xs-12 widget-footer">
					<h3>SOTOCHIKA Co.,Ltd.</h3>
					<p>7th Floor, STAR BUILDING, 33Ter-33bis, Mac Dinh Chi Street,</p>
					<p>Da Kao Ward, District 1, Ho Chi Minh City, Vietnam.</p>
					<p>Tel: (84-8) 6299 5082 / E-mail: info@sotochika.com</p>
				</div>
			</div>
		</div>
	</footer>
